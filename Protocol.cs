...
namespace BooBox {
	public class Protocol {
		...
		public static String CreateREQUESTPLAYLISTLIST(DateTime LastPlaylistListQuery) {
			return "REQUEST PLAYLISTLIST " + LastPlaylistListQuery.ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ"); ;
		}
